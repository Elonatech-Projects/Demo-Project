...
export function WhatWeDoBest() {
  ...
  return (
    <div className="pt-10">
      <h1 className="text-center text-2xl text-black font-bold lg:text-3xl">
        What We do best
      </h1>
      <div className="w-[93%] grid grid-cols-1 gap-10 lg:grid-cols-3 lg:w-[80%] lg:gap-0 m-auto mt-20">
        {/* item-one */}
        <div
