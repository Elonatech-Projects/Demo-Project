...
import { DisplayTwo } from "../VersionHeader/DisplayTwo";
import { DisplayThree } from "../VersionHeader/DisplayThree";
import { OtherGrid } from "../VersionHeader/OtherGrid";
import { Grid } from "../VersionHeader/Grid";

export function DoBest() {
            ...
            {item && (
              <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-[#295a9a] bg-opacity-95 text-white transition-all duration-300">
                ...
                <p className="mt-3 text-center w-[300px] text-[14px]">
                  ...
                  social life online — concerts, events, seminars, and talk
                  shows.
                </p>
                <button className="mt-4 bg-white text-[#295a9a] px-[16px] py-[8px] rounded-md font-medium">
                  See More
          ...
          >
            ...
            {itemOne && (
              <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-[#295a9a] bg-opacity-95 text-white transition-all duration-300">
                ...
                />
                <p className="mt-3 text-center w-[300px] text-[14px]">
                  We help brands and businesses gain a competitive advantage
                  with 12+ years of experience delivering tailored solutions.
                </p>
                <button className="mt-4 bg-white text-[#295a9a] px-[16px] py-[8px] rounded-md font-medium">
                  See More
                </button>
