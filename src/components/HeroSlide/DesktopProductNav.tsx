      ...
      >
        ...
        <ul className="flex items-center gap-6 font-medium relative text-white">
          ...
          <li className="group relative cursor-pointer">
            ...
            <ul className="absolute z-40 left-0 top-full mt-2 text-black bg-white shadow-lg rounded-md p-3 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 text-sm space-y-2">
              {[
                "Shop",
                "Computers",
                "Printers",
        ...
        <div className="flex items-center gap-3 text-white">
          <ShoppingCart className="w-5 h-5 hover:text-blue-500 cursor-pointer text-white" />
